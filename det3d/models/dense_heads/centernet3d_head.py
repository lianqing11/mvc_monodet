...
class CenterNet3DHead(nn.Module, AnchorTrainMixin):
    ...
    def get_bboxes(self, pred_dict, 
                    input_metas, cfg=None, recale=False, img=None,
    ...
    def get_bboxes_single(self, cls_scores, offset, depth,
                 ...
                 input_meta=None, img_idx=None, override_inference_max_num=None):
        if override_inference_max_num is not None:
            K = override_inference_max_num
        else:
        ...
        location = points_img2cam(uv, depth,
                                   torch.tensor(intrinsic).to(depth.device),
    ...
    def generate_ground_truth(self,
        ...
        for idx in range(bsz):
            ...
            boxes_3d = boxes_3d.convert_to(Box3DMode.CAM, rt_mat = extrinsic[idx])
