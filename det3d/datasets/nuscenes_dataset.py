...
class CustomNuScenesDataset(NuScenesDataset):
    ...
    def get_ann_info(self, index):
        ...
        if 'anns_token' in info:
            anns_token = info['anns_token'][mask]
            anns_results['anns_token'] = anns_token
    ...
    def format_results(self, results, jsonfile_prefix=None):
        ...
        if self.dataset_mode == 'detection':
        ...
        elif self.dataset_mode == 'tracking':
            import pdb
            pdb.set_trace()

    def _format_bbox_tracking(self, results, jsonfile_prefix=None):
        import pdb
        pdb.set_trace()
