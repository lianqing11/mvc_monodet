...
def _fill_trainval_infos(nusc,
    ...
    for sample in mmcv.track_iter_progress(nusc.sample):
        ...
        if not test:
            ...
            info['prev_token'] = sample['prev']
            info['next_token'] = sample['next']
            if info['prev_token'] == '':
                info['is_first_frame'] = True
            else:
                info['is_first_frame'] = False
            info['scene_token'] = sample['scene_token']
            info['anns_token'] = sample['anns']
        ...
        for cam in camera_types:
            ...
            coco_2d_dict['images'].append(
                dict(file_name=cam_info['data_path'].split('data/nuscenes/')
                     ...
                     is_first_frame=info['is_first_frame'],
                     width=width,
                     height=height))
...
def get_2d_boxes(nusc,
    ...
    for ann_rec in ann_recs:
        ...
        if mono3d and (repro_rec is not None):
            ...
            repro_rec['ann_token'] = ann_rec['token']
