...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        query_type="3d_box",
        transformer=dict(
            type='NocDetr3DTransformer',
            decoder=dict(
                type='NocDetr3DTransfromerDecoder',
                num_layers=6,
                ...
                transformerlayers=dict(
                    ...
                    attn_cfgs=[
                        dict(
                            ...
                            dropout=0.1),
                        dict(
                            type='DeformableDetr3DCrossAtten',
                            pc_range=point_cloud_range,
                            num_points=1,
                            embed_dims=256)
                    ],
...
train_pipeline = [
    ...
    dict(type='RandomScaleImage3D', img_scale=(800, 450), keep_ratio=True),
